...
const ContactUs = ({ onPress }: any) => {
  return (
    <View>
      <View className="flex justify-center justify-between">
        <Image className="border mx-auto mt-8 mb-1" source={logo} />
        <Text className="text-[23px] font-Yekan font-light text-center py-5 color-[#00469A]">
          آکادمی کدنویسی بحر
        </Text>
        ...
        <View className="flex-row-reverse justify-between my-4">
          ...
          <Text className="font-Gab text-[19px] color-[#474747]">
        ...
        <View className="flex-row-reverse justify-between my-4">
          ...
          <Text className="font-Yekan text-[14px] color-[#474747] mt-1">
            0911 123 1234
          </Text>
        </View>
        <View className="flex-row-reverse mt-4 mb-[90]">
          ...
          <Text className="font-Yekan mt-1 text-[14px] color-[#474747] mr-2">
